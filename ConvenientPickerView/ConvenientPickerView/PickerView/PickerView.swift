...
extension PickerView {
    /// 单列
    public class func singleColPicker(_ toolBarTitle: String,
    ...
    /// 多列不关联
    public class func multipleCosPicker(_ toolBarTitle: String,
    ...
    /// 时间选择器
    public class func datePicker(_ toolBarTitle: String,
